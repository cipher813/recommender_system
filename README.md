...
* 02. Appendices of preliminary EDA/topic modeling of user/artist tags for content-based filter:
 - a. Using scikit-learn's K Means Clustering and t-SNE
 - b. LDA using pyLDAvis  
